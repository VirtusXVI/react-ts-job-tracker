...
export default function Header() {
  ...
  return (
    <div className="w-full h-10 lg:h-15 px-1 flex items-center justify-between bg-amber-200">
        <h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-blue-600">
            Job <span className="text-gray-800">Tracker</span>
        </h1>
        ...
        >
          {theme === 'dark' ? 
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 512 512" fill="black">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 384 512" fill="black">
