...
export default function Header() {
	...
	return (
	<div className="w-full h-10 lg:h-15 px-2 flex items-center justify-between bg-white dark:bg-black fixed">
		<h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-blue-600">
			Job <span className="text-gray-800 dark:text-white">Tracker</span>
		</h1>
		...
		<span className="flex gap-2">
			<button
				...
				onClick={toggleLogin}
			>
				<svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 448 512" fill="black">
			...
			>
				{theme === 'dark' ? 
				<svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 512 512" fill="black">
				...
				<svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 384 512" fill="black">
